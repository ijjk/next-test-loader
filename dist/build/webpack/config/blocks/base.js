"use strict";exports.__esModule=true;exports.base=void 0;var _isWsl=_interopRequireDefault(require("next/dist/compiled/is-wsl"));var _lodash=_interopRequireDefault(require("next/dist/compiled/lodash.curry"));var _webpack=require("next/dist/compiled/webpack/webpack");function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}const isWindows=process.platform==='win32'||_isWsl.default;const base=(0,_lodash.default)(function base(ctx,config){config.mode=ctx.isDevelopment?'development':'production';config.name=ctx.isServer?'server':'client';if(_webpack.isWebpack5){// @ts-ignore TODO webpack 5 typings
config.target=ctx.isServer?'node12.17':['web','es5'];}else{config.target=ctx.isServer?'node':'web';}// Stop compilation early in a production build when an error is encountered.
