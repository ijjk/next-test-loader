...
function formatResults(baseDir, results) {
    let totalNextPluginErrorCount = 0;
    let totalNextPluginWarningCount = 0;
    const formattedResults = results.filter(({ messages  })=>messages === null || messages === void 0 ? void 0 : messages.length
