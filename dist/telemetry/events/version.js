...
function hasBabelConfig(dir) {
    try {
        ...
        const isForTooling = ((ref = res.options) === null || ref === void 0 ? void 0 : (ref1 = ref.presets) === null || ref1 === void 0 ? void 0 : ref1.every((e)=>(e === null || e === void 0 ? void 0 : (ref2 = e.file) === null || ref2 === void 0 ? void 0 : ref2.request) === 'next/babel'
        )) && ((ref3 = res.options) === null || ref3 === void 0 ? void 0 : (ref4 = ref3.plugins) === null || ref4 === void 0 ? void 0 : ref4.length) === 0;
...
function eventCliSession(phase, dir, event) {
    ...
    if (typeof "11.0.2-canary.16" !== 'string') {
        return [];
    }
